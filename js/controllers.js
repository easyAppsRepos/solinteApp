...
.factory('login', function($http, $q) {
  ...
  var deferred = $q.defer();
    ...
    data: {grant_type:'password',client_id:'solinteasyeapp',client_secret:'plmoknijbuhvygctfxrdzesawq',username:'demo10@solinte.net',password:'demo', scope:'perfil admin_rol'}
